...
export function AddFolderModal({ onClose }: { onClose: OnCloseFunction }) {
  ...
  return (
    <S.ModalBlur>
      ...
      <S.CloseClick onClick={handleCloseModal}>
      <img src={"/assets/Icon/_close.png"} alt='닫기이미지' />
        </S.CloseClick>        <S.Feature>폴더 추가</S.Feature>
        <S.ContentInput />
        <S.Button>
          <p>추가하기</p>
        </S.Button>
...
export function ShareModal({ onClose }: { onClose: OnCloseFunction }) {
  ...
  return (
    <S.ModalBlur>
      ...
      <S.CloseClick onClick={handleCloseModal}>
      <img src={"/assets/Icon/_close.png"} alt='닫기이미지' />
        </S.CloseClick>        <S.FeatureNameWrapper>
          <h1>폴더 공유</h1>
          <p>폴더명</p>
